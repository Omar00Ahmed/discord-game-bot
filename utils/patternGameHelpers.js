...
function getRandomPattern(length) {
  ...
  while (pattern.length < length) {
    ...
    const availableJumps = lastNumber
      ? availableNumbers[lastNumber].filter((num) => !pattern.includes(num))
      : [1, 2, 3, 4, 5, 6, 7, 8, 9];
...
function createPatternImage(pattern) {
    ...
    gradient.addColorStop(0, "#0e2620");
    gradient.addColorStop(1, "#0f2526");
